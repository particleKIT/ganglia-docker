...
su nobody -c 'rrdcached -F -p /tmp/rrdcached.pid -s www-data -m 664 -l unix:/tmp/rrdcached.sock -s nogroup -m 777 -P FLUSH,STATS,HELP -l unix:/tmp/rrdcached.limited.sock -b /var/lib/ganglia/rrds -B -j /tmp/rrdcached-journal/ -w 1800 -z 1800 -f 3600 ' -s /bin/sh
