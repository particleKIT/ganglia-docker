...
su nobody -c 'rrdcached -p /tmp/rrdcached.pid -s www-data -m 664 -l unix:/tmp/rrdcached.sock -s nogroup -m 777 -P FLUSH,STATS,HELP -l unix:/tmp/rrdcached.limited.sock -b /var/lib/ganglia/rrds -B' -s /bin/sh 
